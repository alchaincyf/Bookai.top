...
# 🚀 28个ChatGPT使用技巧助你带薪摸鱼


前言：最近ChatGPT和AI相关的资讯已经冷了很多，OpenAI的更新频率也变缓了。到了这个阶段，我倒觉得正好进入了一个适合总结复盘的时候，也是我们可以静下心来，不要有FOMO（fear of missing out）情绪，不要追热点，好好将AI融入自己的工作流的时刻。

这篇内容可以作为我最近半年使用ChatGPT的一个总结，其实本文中的多数技巧我在此前的文章中已经有断断续续分享过，这是一次极端性的梳理，我将内容做成了视频，你可以讲下面的文章配合这个教学视频一起食用：https://www.bilibili.com/video/BV1a8411Q73z/?vd_source=b8ed956bbe6170c4bb6e401414e9d3ee
